...
{ id: "ORD003", customer: "Bob Jhonson", total: 162.5, status: "Shipped", date: "2023-07-03"},
...
const OrderList= () => {
  ...
  const handleSearch = (e) => {
    ...
    const filtered = orderData.filter(
      (order) =>
        order.name.toLocaleLowerCase().includes(term) ||
        order.email.toLocaleLowerCase().includes(term)
    );
    setFilteredOrders(filtered);
  };
  return (
    <motion.div
      className="bg-gray-800 bg-opacity-50 backdrop-blur-md shadow-lg rounded-xl border border-gray-700 mb-8 p-6"
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="relative">
          <input
            ...
            className="bg-gray-700 text-white placeholder-gray-400 rounded-lg pl-10 pr-4 focus:outline-none focus:ring-2 py-2 focus:ring-blue-500"
            ...
            {filteredOrders.map((order) => (
              ...
              >
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-300">
                  <span
  className={`px-2 inline-flex tetx-xs leading-5 font-semibold rounded-full ${
